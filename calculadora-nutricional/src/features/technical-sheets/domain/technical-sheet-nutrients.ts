...
export const ANNEX_II_OPTIONAL_NUTRIENT_FIELDS = [
  ...
  { key: "vitaminA", label: "Vitamina A", unit: "µg RAE" },
  ...
  { key: "biotin", label: "Biotina", unit: "µg" },
  { key: "folicAcid", label: "Ácido fólico", unit: "µg DFE" },
  ...
  { key: "chromium", label: "Cromo", unit: "µg" },
  ...
  { key: "molybdenum", label: "Molibdênio", unit: "µg" },
  { key: "potassium", label: "Potássio", unit: "mg" },
  { key: "selenium", label: "Selênio", unit: "µg" },
