...
const MICRONUTRIENTS = [
    ...
    { name: "copper", label: "Cobre (µg)" },
    { name: "zinc", label: "Zinco (mg)" },
    { name: "selenium", label: "Selênio (µg)" },
    { name: "chromium", label: "Cromo (µg)" },
    { name: "molybdenum", label: "Molibdênio (µg)" },
    { name: "iodine", label: "Iodo (µg)" },
    { name: "fluoride", label: "Flúor (mg)" },
    { name: "vitaminA", label: "Vit. A (µg)" },
    { name: "vitaminD", label: "Vit. D (µg)" },
    { name: "vitaminE", label: "Vit. E (mg)" },
    { name: "vitaminK", label: "Vit. K (µg)" },
    ...
    { name: "biotin", label: "Biotina (µg)" },
    { name: "folicAcid", label: "Ác. Fólico (µg)" },
    { name: "pantothenicAcid", label: "Ác. Pantot. B5 (mg)" },
    { name: "vitaminB12", label: "Vit. B12 (µg)" },
