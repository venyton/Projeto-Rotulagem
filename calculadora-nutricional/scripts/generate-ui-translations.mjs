...
const OVERRIDES = {
  "Tabelas": ["Tabelas", "Nutrition labels", "Etiquetas nutricionales"],
  ...
  "Workspace": ["Workspace", "Workspace", "Área de trabajo"],
  ...
  "Próxima": ["Próxima", "Next", "Siguiente"],
  "Buscar tabela por nome": ["Buscar tabela por nome", "Search nutrition labels by name", "Buscar etiquetas nutricionales por nombre"],
  "Carregando": ["Carregando", "Loading", "Cargando"],
  "Carregando conteúdo": ["Carregando conteúdo", "Loading content", "Cargando contenido"],
  "Carregando editor": ["Carregando editor", "Loading editor", "Cargando editor"],
  "Carregando revisão": ["Carregando revisão", "Loading review", "Cargando revisión"],
  "Carregando workspace": ["Carregando workspace", "Loading workspace", "Cargando espacio de trabajo"],
  "Código de barras inválido.": ["Código de barras inválido.", "Invalid barcode.", "Código de barras no válido."],
  "Dados inválidos.": ["Dados inválidos.", "Invalid data.", "Datos no válidos."],
  "Inspecionar ingrediente": ["Inspecionar ingrediente", "Inspect ingredient", "Inspeccionar ingrediente"],
  "Não foi possível carregar o workspace": ["Não foi possível carregar o workspace", "The workspace could not be loaded", "No se pudo cargar el espacio de trabajo"],
  "Não foi possível trocar de workspace.": ["Não foi possível trocar de workspace.", "The workspace could not be changed.", "No se pudo cambiar de espacio de trabajo."],
  "O arquivo deve ter entre 1 byte e 10 MB.": ["O arquivo deve ter entre 1 byte e 10 MB.", "The file must be between 1 byte and 10 MB.", "El archivo debe tener entre 1 byte y 10 MB."],
  "O endereço pode estar incorreto ou o recurso não está mais disponível.": ["O endereço pode estar incorreto ou o recurso não está mais disponível.", "The address may be incorrect or the resource is no longer available.", "La dirección puede ser incorrecta o el recurso ya no está disponible."],
  "Página não encontrada": ["Página não encontrada", "Page not found", "Página no encontrada"],
  "Tentar novamente": ["Tentar novamente", "Try again", "Intentar de nuevo"],
  "Use um arquivo Excel .xlsx.": ["Use um arquivo Excel .xlsx.", "Use an .xlsx Excel file.", "Use un archivo Excel .xlsx."],
  "Voltar ao início": ["Voltar ao início", "Back to home", "Volver al inicio"],
  "Workspace atual": ["Workspace atual", "Current workspace", "Espacio de trabajo actual"],
  "Workspace inválido": ["Workspace inválido", "Invalid workspace", "Espacio de trabajo no válido"],
  "Workspaces": ["Workspaces", "Workspaces", "Espacios de trabajo"],
};
...
const FRENCH_OVERRIDES = {
  ...
  "Anterior": "Précédent",
  "Próxima": "Suivant",
  "Buscar tabela por nome": "Rechercher des étiquettes nutritionnelles par nom",
  "Carregando": "Chargement",
  "Carregando conteúdo": "Chargement du contenu",
  "Carregando editor": "Chargement de l’éditeur",
  "Carregando revisão": "Chargement de la révision",
  "Carregando workspace": "Chargement de l’espace de travail",
  "Código de barras inválido.": "Code-barres invalide.",
  "Dados inválidos.": "Données invalides.",
  "Inspecionar ingrediente": "Inspecter l’ingrédient",
  "Não foi possível carregar o workspace": "Impossible de charger l’espace de travail",
  "Não foi possível trocar de workspace.": "Impossible de changer d’espace de travail.",
  "O arquivo deve ter entre 1 byte e 10 MB.": "Le fichier doit faire entre 1 octet et 10 Mo.",
  "O endereço pode estar incorreto ou o recurso não está mais disponível.": "L’adresse est peut-être incorrecte ou la ressource n’est plus disponible.",
  "Página não encontrada": "Page introuvable",
  "Tentar novamente": "Réessayer",
  "Use um arquivo Excel .xlsx.": "Utilisez un fichier Excel .xlsx.",
  "Voltar ao início": "Retour à l’accueil",
  "Workspace atual": "Espace de travail actuel",
  "Workspace inválido": "Espace de travail invalide",
